  ...
  Future<void> _register(BuildContext context) async {
    ...
    if (_phoneNumber.phoneNumber == null ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Fill in the fields correctly')));
    } else {
      debugPrint("cool");
      var registered = await Provider.of<AuthController>(context, listen: false)
          .register(
              _phoneNumber.phoneNumber!, _firstName, _lastName, _hasTraining);
      ...
      if (registered) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content:
                Text('This Username is not found! Please try again later')));
      }
    }
  }
